...
public class Event {
	...
	public Event(String event_name, String location, String duration, String overview, String difficulty_level,
			...
			Date drop_time, double price, /*Blob routemap,*/ int total_seat, Category category_id, Organizer organizer_id) {
		super();
...
//	public Blob getRoutemap() {
//		return routemap;
//	}
//
//	public void setRoutemap(Blob routemap) {
//		this.routemap = routemap;
//	}
